...
if ($_POST['submit']) {
	...
	for($i=0; $i<=$rowcount; $i++){
		...
		$SQL = "INSERT INTO tblPodAccess (EmployeeID, Product, Username, URL) VALUES ('$_POST[employeeid]', '$_POST[product][$i]', '$_POST[username][$i]', '$_POST[url][$i]')";
		$result=mysql_query($SQL);
	}

	echo "<br />Thank you for adding the neccessary information.<br /><br />
	<a href='podaccess.php?EmployeeID=".$_POST[employeeid]."'>Click Here</a> to add Pod Specific Access.
	<br /><br /><p><a href='index.php'>Click Here</a> to go back to the Home Page.</p>
	<a href='add_new.php'>Click Here</a> to add another new user.";
}
?>
