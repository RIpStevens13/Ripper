...
<?php
echo "<form action='completed3.php?EmployeeID=".$_GET[EmployeeID]."' method='post'>";
?>

<p><h4><b>Agent Pod Access</b></h4></p><br />
...
<p><input type="submit" id="submit" name="submit" value="Submit" /></p></form>
